...
<body>
	<div id="wrapper" style="background-color: rgba(17, 45, 78, 1);">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="img/logo.png" alt="brand" width="40" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>E-Bengkel</strong></div>
			...
			<ul class="nav navbar-top-links navbar-right">
				<li class="dropdown dropdown-right">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
						<img src="img/<?php echo $sess_admfoto; ?>" width="20px" height="20px"
							padding="0px">&nbsp;&nbsp;<?php echo ucfirst($sess_admname); ?>&nbsp;<i
			...
			<div class="navbar-default sidebar" role="navigation" style="background-color: rgba(17, 45, 78, 1);">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						<li class="sidebar-search">
							<h4 style="color: white;">Sistem Informasi Bengkel</h4>
						...
						<a href="#"><i class="fa fa-chain fa-fw"></i>&nbsp;Data Supplier<span
						...
						?>
						<!-- open <li> tag generated with php, see line 155-160 -->
						<a href="#"><i class="fa fa-th-large fa-fw"></i>&nbsp;Data Barang dan Jasa<span
								class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<?php
